...
export type PublicationStatus = "draft" | "checked" | "verified" | "superseded";
...
export function normalizePublicationStatus(raw: string | null | undefined): PublicationStatus {
  if (raw === "checked" || raw === "verified" || raw === "superseded" || raw === "draft") return raw;
  return "draft";
}
...
export function deckIsReadOnlyPublication(pub: PublicationStatus): boolean {
  return pub === "checked" || pub === "verified" || pub === "superseded";
}
