...
export default function AccountPage() {
  ...
  const sharedTotal =
    data ? data.decks.sharedDraft + data.decks.sharedChecked : 0;
      ...
      <header className="border-b border-stone-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-4xl flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:py-4">
          ...
          <nav className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm sm:justify-end">
            ...
            <Link href="/account" className="font-medium text-pstudy-primary" aria-current="page">
            ...
            <Link href="/my-exams" className="text-stone-600 hover:text-pstudy-primary">
