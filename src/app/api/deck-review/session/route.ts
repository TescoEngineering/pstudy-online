...
import { normalizePublicationStatus } from "@/lib/deck-publication";
...
export async function GET(request: NextRequest) {
  ...
  const deck: Deck = {
    ...
    topic: d.topic ?? null,
    publicationStatus: normalizePublicationStatus(d.publication_status),
    reviewStatus:
  ...
  return NextResponse.json({ deck, inviteId: invite.id, canVerify });
}
